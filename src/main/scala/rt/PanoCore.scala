...
class PanoCore extends Component {
    ...
    val rt = new Area {
        ...
        u_cam_sweep.io.pix_x        <> io.pix_x
        u_cam_sweep.io.pix_y        <> io.pix_y
        // u_cam_sweep.io.pixel_in     <> io.pixel_in
        ...
        //     when((io.pixel_in.req && io.pixel_in.eof) || first_time){
        ...
        //     u_s_time_q_fp.io.op_vld        <> ((io.pixel_in.req && io.pixel_in.eof) || RegNext(first_time))
        ...
        //     }
        //     .elsewhen(io.pixel_in.req && io.pixel_in.eof){
        ...
        sphere.center.y.fromDouble(3.0)
        ...
        u_ray_dir_rot_x.io.op_vld       := True
